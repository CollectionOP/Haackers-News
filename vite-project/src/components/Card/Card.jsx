                ...
                <div className="bg-white overflow-hidden border-b-4 border-blue-500">
                    <div className="p-4 md:p-6">
                        ...
                        <div className="text-sm flex items-center">
                            <svg className="opacity-75 mr-2" xmlns="http://www.w3.org/2000/svg" xmlns: xlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_1" x="0px" y="0px" width="12" height="12" viewBox="0 0 97.16 97.16" space="preserve">
